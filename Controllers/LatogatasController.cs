...
namespace MadarfigyeloWeb.Controllers
{
    public class LatogatasController : Controller
    {
        ...
        {
            return View(await _context.Latogatas.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Datum,Tevekenyseg,Allapot,Faj,TojasSzam,FiokaSzam,FiokakKora,Megjegyzesek")] Latogatas latogatas)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Datum,Tevekenyseg,Allapot,Faj,TojasSzam,FiokaSzam,FiokakKora,Megjegyzesek")] Latogatas latogatas)
        {
            if (id != latogatas.Id)
            {
                return NotFound();
